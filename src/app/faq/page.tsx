...
export default function FAQ() {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-2">
          ...
          <p>
            We provide detailed, itemised bills and treatment receipts that you can submit to your insurer for reimbursement where your policy allows it. We also partner with selected TPAs; contact our billing desk to confirm if your specific corporate or private insurance cashless plan is currently active.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <p>
          Our chief dentist is <strong>Dr. Thushara Sudhakaran (BDS, MDS)</strong>, a qualified endodontist specialising in root canal treatment, with a focus on saving natural teeth through modern, painless techniques. She is a registered dental practitioner with the Kerala State Dental Council.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <p>
          Happy Tooth Smile Studio in Murukkumpuzha is our newest clinic, opening in <strong>June 2026</strong> as a modern, fully-equipped specialist studio. Our Kallambalam clinic continues to serve patients as it has for over five years. Follow us on Instagram and Facebook for opening updates, or call us to be among the first to book.
        </p>
      ),
    },
    {
