            ...
            {clinics
              ...
              .map((clinic, idx) => {
                return (
                  <div
                    key={idx}
                    className="bg-white rounded-3xl border border-primary-teal ring-2 ring-primary-teal/20 shadow-md overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all duration-300"
                  >
                    {/* Header accent */}
