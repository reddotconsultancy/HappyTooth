     ...
     <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <ScrollReveal animation="fade-up" className="lg:col-span-7 space-y-6">
       ...
       <div className="bg-bg-light-blue/40 border border-primary-teal/10 rounded-3xl p-6 md:p-8 space-y-4">
        ...
        <div className="text-xs md:text-sm text-soft-gray space-y-3 leading-relaxed text-justify ">
         <p>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div className="lg:col-span-7 space-y-6">
       ...
       <div className="space-y-4 text-soft-gray leading-relaxed text-sm md:text-base text-justify ">
        <p>
