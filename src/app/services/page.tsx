...
export default function Services() {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      expectDesc: "Porcelain veneers: 10 to 20 years with proper oral hygiene. Composite veneers: 5 to 8 years. Both require avoiding excessive biting force (like ice or hard candy) on bonded surfaces.",
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                  ...
                  <div className={`lg:col-span-7 space-y-6 ${isEven ? "" : "lg:order-1"}`}>
                    ...
                    <div className="space-y-4 text-xs md:text-sm text-soft-gray leading-relaxed text-left">
                      <p>{svc.desc}</p>
