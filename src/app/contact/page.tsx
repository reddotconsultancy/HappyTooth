            ...
            <div className="lg:col-span-8 space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {clinics.map((clinic, idx) => (
                  <div key={idx} className="bg-white rounded-[2rem] border border-border-gray shadow-sm overflow-hidden flex flex-col justify-between hover:border-accent-teal/30 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                    <div className="p-6 md:p-8 border-b border-border-gray/60 bg-[#FAF7F2] space-y-4">
                      ...
                      <div>
                        <h3 className="text-xl font-black text-navy-blue tracking-tight">{clinic.name}</h3>
