        ...
        >
          ...
          <div className="pt-6 border-t border-gray-100 space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <a href="tel:+917356100602" className="block text-sm font-normal text-navy-blue hover:text-primary-teal hover:underline transition">
                Murukkumpuzha: +91 73561 00602
              </a>
              <a href="tel:+918714470808" className="block text-sm font-normal text-navy-blue hover:text-primary-teal hover:underline transition">
